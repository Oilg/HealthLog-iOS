    ...
    static func info(for type: String) -> RiskInfo {
        ...
        case "overload_recovery_risk":
            return RiskInfo(
                ...
                healthDataTypes: ["Вариабельность сердечного ритма (HRV)", "ЧСС", "Продолжительность сна"]
            )
        ...
        case "obesity_risk":
            return RiskInfo(
                ...
                healthDataTypes: ["Масса тела", "ИМТ", "Состав тела (если доступен)", "Количество шагов"]
            )
        case "sedentary_lifestyle_risk":
            return RiskInfo(
                ...
                healthDataTypes: ["Количество шагов", "Время тренировок (если доступно)"]
            )
        case "insufficient_activity_risk":
            return RiskInfo(
                ...
                healthDataTypes: ["Количество шагов"]
            )
        case "cardiometabolic_profile_risk":
            return RiskInfo(
                // swiftlint:disable:next line_length
                explanation: "Алгоритм объединяет доступные кардиометаболические показатели — ИМТ, жировую массу, уровень активности (шаги), VO2max, ЧСС в покое, артериальное давление — и сигнализирует при ухудшении совокупного профиля. Сила сигнала зависит от числа доступных компонентов: чем больше данных, тем точнее оценка риска.",
                ...
                doctorVisitReason: "«Носимое устройство фиксирует ухудшение кардиометаболического профиля: повышенный ИМТ, сниженную активность и/или повышенный пульс покоя. Хочу оценить сердечно-сосудистые риски.»",
        ...
        case "metabolic_syndrome_risk":
            return RiskInfo(
                ...
                healthDataTypes: ["Масса тела", "ИМТ", "Окружность талии (если доступна)", "Артериальное давление", "Количество шагов"]
            )
        case "cardiovascular_obesity_risk":
            return RiskInfo(
                ...
                healthDataTypes: ["Масса тела", "ИМТ", "Количество шагов", "VO2max (кардиофитнес)", "ЧСС", "Артериальное давление (систолическое)"]
            )
        case "recovery_obesity_risk":
            return RiskInfo(
                ...
                healthDataTypes: ["Вариабельность сердечного ритма (HRV)", "ЧСС", "Продолжительность сна", "Масса тела", "Количество шагов"]
            )
        default:
            return RiskInfo(
